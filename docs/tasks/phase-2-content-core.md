...
Post editing, admin listing, the entire media subsystem, and public-read caching are open.
...
- [ ] Object-storage outbound adapter for MinIO and S3-compatible backends
- [ ] `media` and media-relation tables — see [media-relations.md](../backend/media-relations.md)
- [ ] Media domain and service under `internal/core/media`
...
- [ ] Upload validation: MIME allowlist, size ceiling, and filename sanitisation
- [ ] Presigned-URL strategy decision, documented in [media.md](../backend/media.md)

Spec: [media-management.md](../features/media-management.md)
