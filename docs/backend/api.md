...
- `POST /api/v1/admin/categories` (create category; optional parent_id, image_id, slug)
- `PATCH /api/v1/admin/categories/:id` (partial update; JSON null clears parent_id/image_id)
- `DELETE /api/v1/admin/categories/:id` (hard delete; 409 when children exist; posts detach via SET NULL)
- `POST /api/v1/admin/categories/reorder` (set sibling sort_order under optional parent_id)
