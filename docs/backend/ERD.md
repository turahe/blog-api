...
erDiagram
 ...
 varchar ip_hash "HMAC-SHA256 of client IP (plain SHA-256 without APP_ENCRYPTION_KEY) never plaintext stored"
 ...
 varchar reporter_ip_hash "Keyed hash of IP plus UA anonymous flag deduplication"
 ...
 varchar ip_hash "Keyed hash of signup IP optional"
...
| **Analytics** | `analytics_page_views`, `analytics_time_spent`, `analytics_navigation`, `analytics_searches`, `analytics_search_clicks`; derived rollups (not drawn): `analytics_rollup_*`, `analytics_subject_first_seen`, `analytics_rollup_state` — see [analytics.md](./analytics.md#rollups) |
