...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "period length (default by range: up to 92 days day, up to 366 week, else month); day covers at most 92 days",
                        "name": "grain",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/admin/impersonation/start": {
            "post": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "unauthorized, impersonation.sign_in_required (refresh the token first)",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 10,
                        "description": "uploaders to list (1-100)",
                        "name": "top",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/admin/newsletter/issues": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "draft, scheduled, queued, sending, sent, cancelled",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterIssueCreate"
                        }
                    }
                ],
                "responses": {
                    ...
                    "422": {
                        "description": "newsletter.not_configured",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    }
        ...
        "/api/v1/admin/newsletter/issues/{param1}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "include the rendered email",
                        "name": "preview",
                        "in": "query"
                    }
                ],
            ...
            "patch": {
                ...
                "description": "Content and lists change only while draft or scheduled. status moves draft/scheduled to\ndraft, scheduled, queued, or cancelled; queued to cancelled; sending to queued (resume) or\ncancelled. Scheduling and sending need newsletter.issues.send. 409 when the move is not\nallowed or the issue changed meanwhile.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterIssuePatch"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "newsletter.conflict",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
        ...
        "/api/v1/admin/newsletter/provider-config": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "put": {
                ...
                "description": "Saves the sending settings and the complete list set. Lists missing from lists are archived:\nthey keep memberships and history but can no longer be joined or targeted. At least one list\nmust be a default list. The provider, endpoint, and secret are environment settings.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "settings and lists",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterProviderConfig"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/newsletter/subscribers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "pending_confirm, active, unsubscribed, bounced, complained, erased",
                        "name": "status",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/admin/newsletter/subscribers/{param1}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "delete": {
                ...
                "description": "mode=unsubscribe (default) stops all mail. mode=hard_delete erases the address and name;\nthe row stays, suppressed, with its consent history, so the address is never mailed again\nwithout a new opt-in.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "unsubscribe",
                        "description": "unsubscribe or hard_delete",
                        "name": "mode",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/admin/posts/{param1}/revisions": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/admin/posts/{param1}/revisions/{param2}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "revision UUID or revision number",
                        "name": "param2",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v1/admin/posts/{param1}/revisions/{param2}/restore": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/requests.RestoreRevision"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/posts/{param1}/seo": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "SEO fields to change",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.UpdatePostSEO"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/posts/{param1}/seo/preview": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "draft SEO fields",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/requests.PreviewPostSEO"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/analytics/ingest/navigation": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.IngestNavigation"
                        }
                    }
                ],
                "responses": {
                    ...
                    "403": {
                        "description": "analytics.consent_required",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
        ...
        "/api/v1/analytics/ingest/page-view": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.IngestPageView"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.IngestSearch"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.IngestSearchClick"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.IngestTimeSpent"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/auth/register": {
            "post": {
                "description": "Starts a sign-up while the ` + "`" + `security.registration_enabled` + "`" + ` setting is on and emails a\nverification token, valid for 24 hours, to complete at POST /api/v1/auth/verify-email. The answer\nis the same ` + "`" + `202` + "`" + ` whether or not the email already has an account; that account is\nemailed about the attempt instead. No account exists, and the username stays free,\nuntil the email is verified. At most 3 unexpired sign-ups per address are kept; further\nattempts send nothing. Limited to 10 requests per hour per client IP.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "auth.registration.closed",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                    "409": {
                        "description": "user.username.taken",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
        ...
        "/api/v1/auth/verify-email": {
            "post": {
                "description": "Exchanges the emailed sign-up token, together with the password chosen at sign-up, for an\nactive account with a verified email, and signs it in (same token pair as login, with a\n7-day session). Requiring the password means neither someone who registered another\nperson's address nor the owner of an address someone else registered can activate the\naccount alone. A wrong password counts toward the login lockout. Using a token removes\nevery other pending sign-up for the address.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "auth.registration.token_invalid, auth.registration.token_expired",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                    ...
                    "409": {
                        "description": "auth.email.taken, user.username.taken",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                    "429": {
                        "description": "rate limited or locked; see Retry-After",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    }
        ...
        "/api/v1/me/activity/erase": {
            "post": {
                ...
                "description": "Queues the anonymization of the caller's account: activity, consents, sessions, and tokens\nare deleted; email, name, username, avatar, and profile are scrubbed; posts and comments stay,\nshown as \"Deleted user\". Runs within minutes and cannot be undone. Repeating the call while\nthe erasure is pending returns the same request.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.EraseAccount"
                        }
                    }
                ],
                "responses": {
                    ...
                    "403": {
                        "description": "privacy.erase_requires_reauth",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
        ...
        "/api/v1/me/activity/export": {
            "get": {
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "privacy.export_unavailable",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    }
        ...
        "/api/v1/me/newsletter/subscribe": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "lists and format",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterMeSubscribe"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/me/newsletter/subscriptions": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/me/newsletter/unsubscribe": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "lists and optional feedback",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterMeUnsubscribe"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterToken"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "newsletter.token_invalid",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                    "409": {
                        "description": "newsletter.token_used",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                    "410": {
                        "description": "newsletter.token_expired (request a new link)",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterResend"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/newsletter/preferences/{param1}": {
            "get": {
                ...
                "responses": {
                    ...
                    "410": {
                        "description": "newsletter.token_expired",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterPreferences"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterSubscribe"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "validation_error, newsletter.captcha_failed",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
                    "422": {
                        "description": "newsletter.not_configured (no lists)",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
        ...
        "/api/v1/newsletter/unsubscribe": {
            "post": {
                "description": "Stops all newsletter mail for the subscriber behind an unsubscribe token (email footer).\nAlso the RFC 8058 one-click target: mail clients POST List-Unsubscribe=One-Click as a form\nto this URL with ?token=. The token may be sent in the JSON body or the token query\nparameter. Repeating it is harmless.",
                "consumes": [
                    "application/json",
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "unsubscribe token (one-click)",
                        "name": "token",
                        "in": "query"
                    },
                    {
                        "description": "token and optional feedback",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/requests.NewsletterUnsubscribe"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/newsletter/webhooks/provider": {
            "post": {
                "description": "For the delivery provider. The body is {\"events\":[{\"type\":\"hard_bounce|soft_bounce|complaint\",\n\"email\":\"...\",\"occurred_at\":\"RFC 3339\"}]} (1-100 events), signed like outgoing custom_http\nrequests: X-Newsletter-Timestamp (Unix seconds, within 5 minutes) and X-Newsletter-Signature\nv1=hex(HMAC-SHA256(NEWSLETTER_HTTP_SECRET, timestamp + \".\" + body)). Hard bounces and complaints\nsuppress the address. 422 when NEWSLETTER_HTTP_SECRET is not set.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "newsletter.signature_invalid",
                        "schema": {
                            "$ref": "#/definitions/responses.Envelope"
                        }
                    },
    ...
    "definitions": {
        ...
        "requests.NewsletterIssueCreate": {
            ...
            "properties": {
                ...
                "subject": {
                    "type": "string",
                    "maxLength": 200,
                    "example": "September highlights"
                }
            }
        },
        "requests.NewsletterIssuePatch": {
            "type": "object",
            "required": [
                "lists"
            ],
        ...
        "requests.NewsletterMeSubscribe": {
            "type": "object",
            "required": [
                "lists"
            ],
        ...
        "requests.NewsletterMeUnsubscribe": {
            "type": "object",
            "required": [
                "lists"
            ],
        ...
        "requests.NewsletterPreferences": {
            "type": "object",
            "required": [
                "lists"
            ],
        ...
        "requests.NewsletterUnsubscribe": {
            "type": "object",
            "properties": {
                "feedback": {
                    "type": "string",
